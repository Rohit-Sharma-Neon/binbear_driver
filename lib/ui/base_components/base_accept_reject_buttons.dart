...
class BaseAcceptRejectButtons extends StatelessWidget {
  ...
  const BaseAcceptRejectButtons({super.key, this.topMargin, this.bottomMargin, this.isAccepted});
      ...
      children: [
        Expanded(
          child: BaseButton(
            ...
            fontSize: 15,
            fontWeight: !(isAccepted??false) ? FontWeight.w300 : FontWeight.w500,
            titleColor: !(isAccepted??false) ? Colors.white : Colors.black,
            btnColor: !(isAccepted??false) ? BaseColors.secondaryColor : BaseColors.tertiaryColor,
          ),
        ),
        Visibility(
