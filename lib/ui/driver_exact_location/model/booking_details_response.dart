...
class BookingDetailsResponse {
    ...
    factory BookingDetailsResponse.fromJson(Map<String, dynamic> json) => BookingDetailsResponse(
        ...
        data: json["data"] == null ? null : BookingDetailData.fromJson(json["data"]),
...
class BookingDetailData {
    ...
    factory BookingDetailData.fromJson(Map<String, dynamic> json) => BookingDetailData(
        ...
        subCategoryData: json["sub_category_data"] == null ? null : SubCategoryData.fromJson(json["sub_category_data"]),
        categoryData: json["category_data"] == null ? null : CategoryData.fromJson(json["category_data"]),
        binbearData: json["binbear_data"] == null ? null : BinbearData.fromJson(json["binbear_data"]),
        serviceProviderData: json["service_provider_data"] == null ? null : ServiceProviderData.fromJson(json["service_provider_data"]),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "time": time,
        "distance": distance,
        "sub_category_data": subCategoryData?.toJson(),
        "category_data": categoryData?.toJson(),
        "binbear_data": binbearData?.toJson(),
        "service_provider_data": serviceProviderData?.toJson(),
...
class BinbearData {
    ...
    factory BinbearData.fromJson(Map<String, dynamic> json) => BinbearData(
        id: json["id"],
        name: json["name"],
